...
**File:** `api/transactions/status.js`

**Purpose:** Allows frontend to check payment status

**Endpoint:** `GET /api/transactions/status?checkoutRequestId=XXX`
...
### **1. Deploy Server**
Deploy the Express app to your server (EC2) and ensure it is reachable publicly.
