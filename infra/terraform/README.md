...
```bash
terraform init
terraform plan -var="project_name=kejayacapo-duka" -var="aws_region=eu-west-1" -var="key_name=YOUR_KEYPAIR_NAME" -var="repo_url=https://github.com/YOUR_ORG/YOUR_REPO.git"
terraform apply -var="project_name=kejayacapo-duka" -var="aws_region=eu-west-1" -var="key_name=YOUR_KEYPAIR_NAME" -var="repo_url=https://github.com/YOUR_ORG/YOUR_REPO.git"
```
